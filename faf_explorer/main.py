#!/usr/bin/env python3
"""
FAF Explorer - Main Application Logic
"""
...
# Setup logging first
from faf_explorer.logger import setup_logging, get_logger

# Load project configuration
def load_project_config():
    """Load project configuration from config/project.json"""
    config_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'config', 'project.json')
    try:
